...
Также, досточно перед каждым последующим пунктом списка просто указать <1.> без порядковой нумерации. Например так:
1. Список 1
1. Список 2
1. Список 3
...
Петров Петр Петрович | 1998 | Муж | 234555
...
На данный момент в инструкции приведены лишь некоторые возможности использования синтаксиса языка разметки Markdown.
